...
class _MarketDetails extends State<MarketDetails>
  ...
  Future<void> getMarketDetailFromDB() async {
    ...
    final url =
        "$SERVER_IP/ticket/ticketPrice/${widget.product_name!}/${widget.seat_class!}";
    try {
                                                ...
                                                Padding(
                                                  ...
                                                  child: TextField(
                                                    ...
                                                    decoration: InputDecoration(
                                                      hintText:
                                                          '입찰가 입력(최소 ${minimum_bid_price.replaceAllMapped(reg, mathFunc)} 원 이상)',
                                                      counterText: "",
                                              ...
                                              ElevatedButton(
                                                  onPressed: () async {
                                                    if (int.parse(
                                                        ...
                                                        auction_details[
                                                        'immediate_purchase_price']) {
                                                      final immediate_purchase_price =
                                                      auction_details[
                                                      'immediate_purchase_price'];
                                                              ...
                                                              content: RichText(
                                                                  text: TextSpan(
                                                                    children: [
                                                                      ...
                                                                      TextSpan(
                                                                          text:
                                                                          "${roundDouble(immediate_purchase_price / _klayCurrency, 2)} KLAY",
                                                                          style:
                                                                          const TextStyle(
                                                                            fontWeight:
                                                                            FontWeight
                                                                      ...
                                                                      const TextSpan(
                                                                          text:
                                                                          "즉시 입찰 시 자동으로 결제가 진행되며 이는 되돌릴 수 없습니다.",
                                                                          style:
                                                                          TextStyle(
                                                                            fontWeight:
                                                                            FontWeight
                                                      ...
                                                      if (immidiate_purchase) {
                                                        final kas_address_data =
                                                        await getKasAddress(); // jwt token으로부터 kas_address 가져오기
                                                        final owner =
                                                        widget.owner!;
                                                        ...
                                                        Map<String, dynamic>
                                                        klayTransactionData =
                                                        await klayTransaction(
                                                            bidder,
                                                            payment_klay
                                                                .toString(),
                                                            owner);

                                                        if (klayTransactionData[
                                                        'statusCode'] !=
                                                            200) {
                                                          // 트랜잭션 실패
                                                          String message =
                                                        ...
                                                        Map<String, dynamic>
                                                        updateTicketOwnerData =
                                                        await updateTicketOwner(
                                                            bidder,
                                                            widget
                                                                .token_id!);

                                                        if (updateTicketOwnerData[
                                                        'statusCode'] !=
                                                            200) {
...
DataRow dataRow(
    String ranking, String bidder, String bid_date, String bid_price) {
  return DataRow(
    cells: <DataCell>[
      DataCell(Container(
        height: 50,
