...
class _MarketDetails extends State<MarketDetails>
  ...
  Future<void> getMarketDetailFromDB() async {
    ...
    final url =
        "$SERVER_IP/ticket/ticketPrice/${widget.product_name!}/${widget
        .seat_class!}";
    try {
        ...
        if (data['statusCode'] == 200) {
          ...
          for (Map<String, dynamic> bid in bid_data) {
            if (bid['bidder'] == kas_address) {
              ...
              minimum_bid_price =
                  (bid['bid_price'] + auction_details['bid_unit']).toString();
              if ((bid['bid_price'] + auction_details['bid_unit']) >
                  auction_details['immediate_purchase_price']) {
                minimum_bid_price =
                    auction_details['immediate_purchase_price'].toString();
              }
              setState(() {});
              break;
            }
                                        ...
                                        child: Container(
                                          ...
                                          decoration: BoxDecoration(
                                            ...
                                            borderRadius: BorderRadius.circular(
                                                10),
                                            color: (theme ? const Color(
                                                0xffe8e8e8) : const Color(
                                                0xffffffff)),
                                          ),
                                          child: TabBar(
                                            indicator: (tabcontroller!.index ==
                                                0) ?
                                            BoxDecoration(
                                ...
                                children: ListTile.divideTiles(
                                  ...
                                  ListTile(
                                      title: Row(children: [
                                        ...
                                        Text(
                                            "${auction_details['auction_end_date']
                                                .substring(0, 10)
                                                .replaceAll("-",
                                                ".")} ${auction_details['auction_end_date']
                                                .substring(11, 16)}",
                                  ...
                                  ListTile(
                                      title: Row(children: [
                                        ...
                                        Text(
                                            "${auction_details['auction_start_price']
                                                .toString()
                                                .replaceAllMapped(
                                                reg, mathFunc)} 원",
                                            style: TextStyle(
                                        ...
                                        children: [
                                          ...
                                          Padding(
                                            ...
                                            child: TextField(
                                              onChanged: (bid_price) {
                                                setState(() {
                                                  int? _parse = int.tryParse(
                                                      bid_price);
                                                  if (_parse != null) {
                                                    if (_parse >
                                                        auction_details['immediate_purchase_price']) {
                                                      bid_price_controller
                                                          .text =
                                                          auction_details['immediate_purchase_price']
                                                              .toString();
                                                    }
                                            ...
                                            onPressed: () async {
                                              ...
                                              int.parse(
                                                ...
                                                if (immidiate_purchase) {
                                                  ...
                                                  if (kas_address_data['statusCode'] !=
                                                      200) {
                                                  ...
                                                  final bidder = kas_address_data['data'][0]['kas_address'];
                                                  double payment_klay = auction_details['immediate_purchase_price'] /
                                                      _klayCurrency;
                                                  ...
                                                  Map<String,
                                                      dynamic> klayTransactionData =
                                                  await klayTransaction(bidder,
                                                      payment_klay.toString(),
                                                      owner);
                                                  if (klayTransactionData['statusCode'] !=
                                                      200) {
                                                    // 트랜잭션 실패
                                                  ...
                                                  Map<String, dynamic>
                                                  kip17TokenTransferData =
                                                  await kip17TokenTransfer(
                                                      details['category'],
                                                      widget.token_id!, owner,
                                                      owner, bidder);

                                                  if (kip17TokenTransferData['statusCode'] !=
                                                      200) {
                                                    // 토큰 전송 실패
                                                    ...
                                                    payment_klay =
                                                        payment_klay + 0.000525;
                                                    Map<String,
                                                        dynamic>klayTransactionData =
                                                    await klayTransaction(owner,
                                                        payment_klay.toString(),
                                                        bidder);
                                                    if (klayTransactionData['statusCode'] ==
                                                        200) {
                                                  ...
                                                  Map<String,
                                                      dynamic>updateTicketOwnerData =
                                                  await updateTicketOwner(
                                                      bidder, widget.token_id!);
                                                  if (updateTicketOwnerData['statusCode'] !=
                                                      200) {
                                                  ...
                                                  Map<String, dynamic>
                                                  terminateAuctionData =
                                                  await terminateAuction(
                                                      bidder);

                                                  if (terminateAuctionData['statusCode'] !=
                                                      200) {
                                              ...
                                              final selected = await displayDialog_YesOrNo(
                                                  context, "입찰하기",
                                                  "위 입찰가로 경매에 참여하시겠습니까?");
                                              if (selected) {
                                                bid();
  ...
  DataRow dataRow(String ranking, String bidder, String bid_date,
      String bid_price) {
    return DataRow(
      cells: <DataCell>[
        DataCell(Container(
