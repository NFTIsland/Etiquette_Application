                     ...
                     Column(
                        children : <Widget>[
                                  ...
                                  Flexible(
                                    child :
                                      ...
                                      //border : OutlineInputBorder()
                                        ...
                                        onChanged : (text){setState((){id = text;});}//바뀔 때마다 id를 입력되어 있는 값으로 변경
                                      )
                                  ),
                                  Container(
                                    padding : EdgeInsets.only(left : 10),//텍스트 필드와 약간의 여백 생성
                                    child :
                                  ElevatedButton(onPressed: (){},//인증받기 위해 누르는 버튼, 아직 기능 구현 안함
                                  child : Text("인증"),
                          ...
                          Padding(//인증번호를 위한 공간
                              ...
                              child : Row(
                                  children : <Widget>[
                                    Flexible(
                                        child :
                                        TextField( keyboardType: TextInputType.number,//기본으로 숫자 모양의 키보드가 호출되도록 설정
                                          decoration: InputDecoration(
                                            //icon: const Text("ID:"),
                                              labelText : "인증번호",//인증번호 입력하는 공간
                                              //border : OutlineInputBorder()
                                          ),
                                            onChanged : (text){setState(() {//바뀔때마다 저장
                                              id_auth = text;
                                            });}
                                        )
                                    ),
                                    Container(
                                      padding: EdgeInsets.only(left : 10),//텍스트 필드와 약간의 여백 생성
                                      child :
                                      ElevatedButton(onPressed: (){},//인증 확인 버튼, 아직 기능 구현 안함
                                          child : Text("확인"),//
                                          style : ElevatedButton.styleFrom(
                                          primary : Colors.deepPurpleAccent//버튼 색깔 설정
                                      )
                          ...
                          Padding(
                              ...
                              child : TextField( obscureText : true, keyboardType: TextInputType.text,//기본으로 자판 모양의 키보드가 호출되도록 설정, pw 안보이도록 가림
                                decoration: InputDecoration(
                                    //icon: const Text("PW:"),
                          ...
                          Padding(
                              ...
                              child : TextField( keyboardType: TextInputType.text, obscureText: true,//기본으로 자판 모양의 키보드가 호출되도록 설정, pw 안보이도록 가림
                                decoration: InputDecoration(
                                    //icon: const Text("재확인:"),
                                  ...
                                  onChanged : (text){setState(() {
                                    pw_auth = text;//바뀔 떄마다 저장
                                  });}
                              )
                          ),
                          Padding(
                              padding : EdgeInsets.fromLTRB(80, 20, 80, 0),//재확인 입력 칸과 여백 및, 좌우 공간 여백 설정
                              child : TextField(keyboardType: TextInputType.text,//기본으로 자판 모양의 키보드가 호출되도록 설정, pw 안보이도록 가림
                                decoration: InputDecoration(
                                    //icon: const Text("이름:"),
